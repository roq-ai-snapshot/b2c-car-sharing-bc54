  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless car booking with B2C Car Sharing v1 - Connecting individual customers and available cars efficiently through centralized dashboards."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless car booking with B2C Car Sharing v1 - Connecting individual customers and available cars efficiently through centralized dashboards.`}
            </Text>
            <Box
